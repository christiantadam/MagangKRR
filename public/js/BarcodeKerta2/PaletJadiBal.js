$(document).ready(function () {
    ...
    // Dapatkan referensi ke elemen input pertama dan kedua
    const tanggalInput = document.getElementById("tanggalInput");
    const tanggalOutput = document.getElementById("tanggalOutput");

    // Tambahkan event listener ke elemen input pertama
    tanggalInput.addEventListener("input", function () {
        // Dapatkan nilai tanggal yang dipilih dari input pertama
        const selectedDate = tanggalInput.value;

        // Perbarui nilai input kedua dengan tanggal yang dipilih
