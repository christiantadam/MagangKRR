$(document).ready(function () {
    ...
    document.getElementById('ButtonShift').addEventListener("click", function (event) {
        ...
        document.getElementById('ButtonScanBarcode').disabled = false;

        // Other logic or actions related to the "Pilih Shift" button click
        // ...
    });
    ...
    document.getElementById('ButtonScanBarcode').addEventListener("click", function (event) {
        ...
        // Enable the "Pilih Sub Kelompok" button
        document.getElementById('ButtonPilihSubKelompok').disabled = false;

        // Other logic or actions related to the "Scan Barcode" button click
        // ...
    });

    document.getElementById('ButtonPilihSubKelompok').addEventListener("click", function (event) {
        event.preventDefault();

        // Enable the "Pilih Type" button
        document.getElementById('ButtonType').disabled = false;

        // Other logic or actions related to the "Pilih Sub Kelompok" button click
        // ...
    });
