$(document).ready(function () {
    ...
    $("#CekBarcode").on("click", function () {
        ...
        var url = "/ABM/BarcodeRollWoven/CekBarcode/" + NoIndeks + "." + txtbarcode + ".getBarcode";
            ...
            .then(data => {
                ...
                if (data.length > 0) {
                    if (data[0].Type_Transaksi === "22" && data[0].Status === "N" && data[0].Ditembak === "") {
                        alert("Barcode Tidak Jadi Dibuat oleh Divisi " + data[0].IdDivisi);
                        ...
                        alert("Barcode Belum Dikirim Oleh Divisi " + data[0].IdDivisi);
                        ...
                        alert("Barcode Dikirim ke Divisi " + data[0].IdDivisi);
                    } else if (data[0].Ditembak === "2" && data[0].Pengirim !== "" && data[0].DivTujuan !== "") {
                        alert("Barcode Sudah Discan Oleh Divisi " + data[0].IdDivisi + ", Cek Barcode di Gagal Terima");
                    } else if (data[0].Ditembak === "3" && data[0].DivTujuan === "") {
                        alert("Barcode Salah, Hubungi EDP");
                    } else if (data[0].Ditembak === "2" && data[0].Pengirim !== "" && data[0].DivTujuan === "") {
                        alert("Barcode Salah, Hubungi EDP");
                        ...
                        alert("Barcode Sudah Diterima Oleh Divisi " + data[0].IdDivisi);
                    } else if (data[0].Type_Transaksi === "25" || data[0].Type_Transaksi === 27) {
                        alert("Barcode Milik Divisi " + data[0].IdDivisi);
                        ...
                        alert("Barcode Sudah Dihanguskan Oleh Divisi " + data[0].IdDivisi);
                    } else if (data[0].Type_Transaksi === "9" || data[0].Type_Transaksi === "9") {
                        alert("Barcode Sudah Dijual Oleh Divisi " + data[0].IdDivisi);
                        ...
                        alert("Barcode Milik Divisi " + data[0].IdDivisi + " Sudah Tidak Dipakai Lagi");
                    } else if (data[0].Type_Transaksi === "26") {
                        alert("Barcode Sudah Dihanguskan Oleh Divisi " + data[0].IdDivisi);
                    } else if (data[0].Type_Transaksi === "27") {
                        alert("Barcode Sudah Dimutasi Satu Divisi Oleh Divisi " + data[0].IdDivisi);
                    } else {
                        alert("Barcode Tidak Ditemukan, Hubungi EDP");
                    }
                } else {
                    alert("Data yang diinput salah.")
                }
