$(document).ready(function () {
    ...
    selectElement.addEventListener("change", function () {
        ...
        fetch("/ProgramPayroll/ProsesGajiStaff/" + selectedValue + ".getData")
            .then((response) => {
                if (!response.ok) {
    ...
    prosesButton.addEventListener("click", function () {
        ...
        form.setAttribute("action", "ProsesGajiStaff/{Periode}");
        ...
        ifUpdate.value = "Proses Gaji Staff"; // Set the value of the input field to the corresponding data
