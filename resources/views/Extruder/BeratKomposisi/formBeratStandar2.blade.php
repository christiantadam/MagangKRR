<div id="berat_woven2" class="form hidden" data-aos="fade-up">
    <form action="#" method="">
...
<div id="berat_jumbo2" class="form hidden" data-aos="fade-up">
    <form action="#" method="">
...
<div id="berat_adstar2" class="form hidden" data-aos="fade-up">
    <form action="#" method="">
...
<div id="berat_circular2" class="form hidden" data-aos="fade-up">
    <form action="#" method="">
...
<div id="berat_assesoris2" class="form hidden" data-aos="fade-up">
    <form action="#" method="">
        ...
        <div class="row mt-3">
            ...
            <div class="form-group col-md-6 mt-3 mt-md-0">
                <input type="text" class="form-control" name="kode_assesoris" placeholder="Kode Assesoris" required>
            </div>
        </div>
