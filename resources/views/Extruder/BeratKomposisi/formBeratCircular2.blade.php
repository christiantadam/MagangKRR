    ...
    <div id="berat_circular2" class="form" data-aos="fade-up">
        ...
        <div class="row mt-3">
            ...
            <div class="form-group col-md-6 mt-3 mt-md-0">
                <input type="text" class="form-control" id="kode_gelondongan" required>
            </div>
        </div>
        ...
        <div class="row mt-3">
            ...
            <div class="form-group col-md-9 mt-3 mt-md-0">
                <textarea class="form-control" id="berat_type" rows="3" required></textarea>
            </div>
        </div>
        ...
        <div class="row mt-3">
            ...
            <div class="form-group col-md-6 mt-3 mt-md-0">
                <div class="input-group">
                    <input type="number" class="form-control" id="berat_standar1" required>
        ...
        <div class="row mt-3">
            ...
            <div class="form-group col-md-6 mt-3 mt-md-0">
                <div class="input-group">
                    <input type="number" class="form-control" id="berat_standar2" required>
                    <span class="input-group-text">Gram</span>
                </div>
            </div>
        </div>
        ...
        <div class="row mt-3">
            ...
            <div class="form-group col-md-6 mt-3 mt-md-0">
                <input type="number" class="form-control" id="berat_karung" required>
            </div>
        </div>
        ...
        <div class="row mt-3">
            ...
            <div class="form-group col-md-6 mt-3 mt-md-0">
                <input type="number" class="form-control" id="berat_inner" required>
            </div>
        </div>
        ...
        <div class="row mt-3">
            ...
            <div class="form-group col-md-6 mt-3 mt-md-0">
                <input type="number" class="form-control" id="berat_lami" required>
            </div>
        </div>
        ...
        <div class="row mt-3">
            ...
            <div class="form-group col-md-6 mt-3 mt-md-0">
                <input type="number" class="form-control" id="berat_conductive" required>
            </div>
        </div>
