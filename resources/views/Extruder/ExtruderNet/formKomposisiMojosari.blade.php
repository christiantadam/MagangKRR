    ...
    <form>
        ...
        <div class="row mt-3">
            ...
            <div class="col-md-5 d-flex align-items-end row">
                <div class="col-md-4">
                    <button type="submit" class="btn btn-outline-primary">Tambah Afalan</button>
                </div>
                <div class="col-md-8">
                    <table class="table">
                        <thead>
                ...
                <div class="row mt-3">
                    <div class="col-md-12 d-flex justify-content-center">
                        <button type="submit" class="btn btn-outline-primary"
                            style="margin-right: 2em;">Tambah<br>Cadangan</button>
                        <button type="submit" class="btn btn-outline-primary"
                            style="margin-right: 2em;">Tambah<br>Bahan</button>
                        <button type="submit" class="btn btn-outline-primary"
                            style="margin-right: 2em;">Koreksi</button>
