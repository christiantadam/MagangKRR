...
<div id="komposisi_tropodo_d" class="form" data-aos="fade-up">
    <form>
        ...
        <div class="row mt-3">
            <div class="col-md-5 form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="mesin2" style="width: 12.5em;">
                    <button type="button" class="btn btn-outline-secondary">...</button>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-md-4">
                        <div class="row mt-3 justify-content-center">
                            <div class="col-md-4 text-center">
                                <button type="submit" class="btn btn-outline-primary" style="height: -webkit-fill-available; width: 125px;">Tambah Bahan</button>
                            </div>
                            <div class="col-md-4 text-center">
                                <button type="submit" class="btn btn-outline-primary" style="height: -webkit-fill-available; width: 125px;">Koreksi</button>
                            </div>
                            <div class="col-md-4 text-center">
                                <button type="submit" class="btn btn-outline-primary" style="height: -webkit-fill-available; width: 125px;">Hapus</button>
                            </div>
                        </div>
        ...
        <div class="row mt-3">
            <div class="col-md-6 text-center">
                <button type="submit" class="btn btn-outline-primary">Komposisi Baru</button>
                <button type="submit" class="btn btn-outline-primary">Koreksi</button>
