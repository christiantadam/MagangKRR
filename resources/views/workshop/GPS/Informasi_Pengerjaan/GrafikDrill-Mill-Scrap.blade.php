  ...
  <div class="container-fluid">
    <div class="row justify-content-center">
      <div class="col-md-10 RDZMobilePaddingLR0">
        <div class="card">
          <div class="card-header">Drill-Mill-Scrap</div>
          <div class="card-body RDZOverflow RDZMobilePaddingLR0">
            ...
            <div class="mb-3">
              <div class="row">
                <button class="btn btn-success" onclick="Gantitap('drill1')" id="drill11">Drill</button>
                <button class="btn btn-success" onclick="Gantitap('drill2')" id="drill22">Drill</button>
                <button class="btn btn-success" onclick="Gantitap('mill')" id="mill1">Mill</button>
            ...
            <div id="kalenderdrill2" style="display: none">
              <div id="JenisBulan1drill2" style="display: none"> {{-- bulan 31 --}}
                <div style="padding-top:10px">
                  <div class="row">
                    <div id='1' style="width: 125px; text-align: center; padding-left: 10px;">
                      1
              ...
              <div id="JenisBulan2drill2" style="display: none"> {{-- bulan 30 --}}
                <div style="padding-top:10px">
                  <div class="row">
                    <div id='1' style="width: 125px; text-align: center; padding-left: 10px;">
                      1
              ...
              <div id="JenisBulan3drill2" style="display: none"> {{-- bulan 29 --}}
                <div style="padding-top:10px">
                  <div class="row">
                    <div id='1' style="width: 125px; text-align: center; padding-left: 10px;">
                      1
              ...
              <div id="JenisBulan4drill2" style="display: none"> {{-- bulan 28 --}}
                <div style="padding-top:10px">
                  <div class="row">
                    <div id='1' style="width: 125px; text-align: center; padding-left: 10px;">
                      1
            ...
            <div id="kalendermill" style="display: none">
              <div id="JenisBulan1mill" style="display: none"> {{-- bulan 31 --}}
                <div style="padding-top:10px">
                  <div class="row">
                    <div id='1' style="width: 125px; text-align: center; padding-left: 10px;">
                      1
              ...
              <div id="JenisBulan2mill" style="display: none"> {{-- bulan 30 --}}
                <div style="padding-top:10px">
                  <div class="row">
                    <div id='1' style="width: 125px; text-align: center; padding-left: 10px;">
                      1
              ...
              <div id="JenisBulan3mill" style="display: none"> {{-- bulan 29 --}}
                <div style="padding-top:10px">
                  <div class="row">
                    <div id='1' style="width: 125px; text-align: center; padding-left: 10px;">
                      1
              ...
              <div id="JenisBulan4mill" style="display: none"> {{-- bulan 28 --}}
                <div style="padding-top:10px">
                  <div class="row">
                    <div id='1' style="width: 125px; text-align: center; padding-left: 10px;">
                      1
            ...
            <div id="kalenderscrap" style="display: none">
              <div id="JenisBulan1scrap" style="display: none"> {{-- bulan 31 --}}
                <div style="padding-top:10px">
                  <div class="row">
                    <div id='1' style="width: 125px; text-align: center; padding-left: 10px;">
                      1
              ...
              <div id="JenisBulan2scrap" style="display: none"> {{-- bulan 30 --}}
                <div style="padding-top:10px">
                  <div class="row">
                    <div id='1' style="width: 125px; text-align: center; padding-left: 10px;">
                      1
              ...
              <div id="JenisBulan3scrap" style="display: none"> {{-- bulan 29 --}}
                <div style="padding-top:10px">
                  <div class="row">
                    <div id='1' style="width: 125px; text-align: center; padding-left: 10px;">
                      1
              ...
              <div id="JenisBulan4scrap" style="display: none"> {{-- bulan 28 --}}
                <div style="padding-top:10px">
                  <div class="row">
                    <div id='1' style="width: 125px; text-align: center; padding-left: 10px;">
                      1
