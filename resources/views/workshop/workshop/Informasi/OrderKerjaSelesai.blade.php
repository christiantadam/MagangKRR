...
<style>
  ...
  <div class="card-body">
    ...
    <div class="table-responsive">
      <table class="table mt-3" style="width: max-content" id="TableOrderKerjaSelesai">
  ...
  <script src="{{ asset('js/Andre-WorkShop/Workshop/Informasi/OrderKerjaSelesai.js') }}"></script>
@endsection
