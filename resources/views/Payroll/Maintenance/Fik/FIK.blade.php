                ...
                <form action="#" method="post" role="form">
                    ...
                    <div class="row mt-3">
                        <div class="col- row justify-content-md-center">
                            <div class="text-center col-md-auto"><button type="submit">Tampilkan Data</button></div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-9 mt-3 mt-md-0">
                            <input type="date" class="form-control" name="Nama_divisi" id="Nama_divisi" placeholder="Nama / ID Divisi" required> <h1> / </h1>
                        </div>
                    </div>
