            ...
            <div class="col-md-10 RDZMobilePaddingLR0">
                <div class="card">
                    ...
                    <div class="card-body RDZOverflow RDZMobilePaddingLR0">
                        ...
                        <div class="row" style="">
                            <div class="form-group col-md-1 d-flex justify-content-end">
                                <span class="aligned-text">Shift Lama:</span>
                            </div>
                            <div class="form-group col-md-9 mt-3 mt-md-0">
                                <input class="form-control" type="text" id="ShiftLama" readonly
                        ...
                        <div class="row" style="">
                            <div class="form-group col-md-1 d-flex justify-content-end">
                                <span class="aligned-text">Shift Baru:</span>
                            </div>
                            <div class="form-group col-md-9 mt-3 mt-md-0">
                        ...
                        <div style="text-align: right; margin-top: 20px;">
                            <button type="submit" class="btn btn-primary" id="prosesButton" onclick="prosesData()">Proses</button>
