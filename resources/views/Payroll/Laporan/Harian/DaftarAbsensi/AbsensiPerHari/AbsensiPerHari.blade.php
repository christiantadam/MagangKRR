                ...
                <form action="#" method="post" role="form">
                    <div class="row">
                        ...
                        <div class="form-group col-md-9 mt-3 mt-md-0">
                            ...
                            <label for="staff" style="display: inline-block; margin-right: 5px; margin-left: 10px;">Lembur Staff</label>

                            <input type="radio" id="staff" name="pekerja" value="staff" checked style="vertical-align: middle;">
                            <label for="staff" style="display: inline-block; margin-right: 5px; margin-left: 10px;">Lembur Harian</label>

                            <input type="radio" id="staff" name="pekerja" value="staff" checked style="vertical-align: middle;">
                            <label for="staff" style="display: inline-block; margin-right: 5px; margin-left: 10px;">Absensi Harian</label>
                        </div>
                    </div>
