                                ...
                                <form action="#" method="post" role="form">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-9 mt-3 mt-md-0">
                                            <input type="text" class="form-control" name="Kode_barang" id="Kode_barang" id="txtbarcode"
                                    ...
                                    <div class="row mt-3">
                                        <div class="col- row justify-content-md-center">
                                            ...
                                            <div class="text-center col-md-auto"><button id="txtbarcode" style="width: 100px" type="button">Cek</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
