                                    ...
                                    <div style="display: flex; flex-direction: column; gap:5px; white-space:nowrap">
                                        ...
                                        <div style="display: flex;flex-direction: row;align-items:center;gap:1%">
                                            <div class="text-center col-md-auto mt-3"><button type="button"
                                                    id="ButtonScanBarcode" onclick="openModal1()"
                                                    style="width:180px; height: 50px" disabled>Scan
                                                    Barcode</button>
                                            </div>
                                        ...
                                        <div style="display: flex; flex-direction: row; align-items:center; gap:1%">
                                            <div class="text-center col-md-auto mt-3">
                                                <button type="button" onclick="openModal5()" id="ButtonPilihSubKelompok"
                                                    style="width:180px; height: 50px" disabled>Pilih
                                                    Sub Kelompok</button>
                                            </div>
                                        ...
                                        <div style="display: flex;flex-direction: row;align-items:center;gap:1%">
                                            <div class="text-center col-md-auto mt-3"><button type="button"
                                                    id="ButtonTimbang" style="width:180px; height: 50px"
                                        ...
                                        <div style="display: flex;flex-direction: row;align-items:center;gap:1%">
                                            <div class="text-center col-md-auto mt-3"><button type="button"
                                                    id="ButtonPrintBarcodeKonversi" style="width:180px; height: 50px"
                                                    disabled>Print
                                    ...
                                    <div class="card" style="width: 100%; height: 510px">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-5 mt-3 mt-md-0">
                                                <textarea class="form-control" name="asal" id="TypeAsal" rows="asal" placeholder="Asal"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-5 mt-3 mt-md-0">
                                                <textarea class="form-control" name="tujuan" rows="tujuan" placeholder="Tujuan" id="tujuan"
                                                    style="height: 100px" readonly></textarea>
                                            </div>
                                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-5 mt-3 mt-md-0">
                                                        <input class="form-control" type="text" name="Divisi"
                                                            id="Divisi" rows="Divisi" placeholder="Divisi" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
