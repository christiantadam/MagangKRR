                            ...
                            <form method="POST" action="">
                                ...
                                <div class="card" style="display: flex;">
                                    <div  style="width: 100%;">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="col-md-2">
                                                <input type="text" id="idJenisCustomer" name="idJenisCustomer" class="form-control" style="width: 100%">
                                            </div>
                                            <div class="col-md-2">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="col-md-3">
                                                <input type="number" id="nilaiKurs" name="nilaiKurs" class="form-control" style="width: 100%">
                                            </div>
                                        </div>
                                        <div class="d-flex">
                                            <div class="col-md-3">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="col-md-5">
                                                <select name="userPenagihSelect" id="userPenagihSelect" class="form-control">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="col-md-3">
                                                <select id="dokumenSelect" name="dokumenSelect" id="dokumen" class="form-control">
                                ...
                                <div class="card">
                                    <div class="d-flex">
                                        ...
                                        <div class="col-md-3">
                                            <input type="text" id="uangMasuk" name="uangMasuk" class="form-control" style="width: 100%">
                                        </div>
                                        <div class="col-md-2">
                                           Enter
                                        </div>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="col-md-3">
                                            <input type="number" id="nilaiSblmPPN" name="nilaiSblmPPN" class="form-control" style="width: 100%">
                                        </div>
                                    </div>
                                    <div class="d-flex">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                            <input type="number" id="nilaiPpn" name="nilaiPpn" class="form-control" style="width: 100%">
                                        </div>
                                    </div>
                                    <div class="d-flex">
                                        <div class="col-md-3">
