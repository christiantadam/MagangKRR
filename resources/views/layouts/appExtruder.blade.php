                            ...
                            <ul>
                                <li class="dropdown">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="/Extruder/ExtruderNet/formTropodoOrderStatus">Maintenance Status
                                                Order</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown">
                                    ...
                                    <ul>
                                        <li><a href="/Extruder/ExtruderNet/formTropodoKonversiMohon">Permohonan Konversi
                                                Barang</a></li>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul>
                                        <li><a href="/Extruder/ExtruderNet/formTropodoBenangMohon">Permohonan Sortir
                                                Benang NG</a></li>
                            ...
                            <ul>
                                <li class="dropdown">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="/Extruder/ExtruderNet/formMojosariOrderStatus">Maintenance Status
                                                Order</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul style="transition: 0.3s; left: -75%;">
                                        <li><a href="/Extruder/ExtruderNet/formMojosariD_OrderMaintenance">Maintenance
                                                Order Extruder</a></li>
                                        <li><a href="/Extruder/ExtruderNet/formMojosariD_OrderACC">ACC Order</a></li>
                                        <li><a href="/Extruder/ExtruderNet/formMojosariD_OrderStatus">Maintenance Status
                                                Order</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown">
                                    ...
                                    <ul style="transition: 0.3s; left: -75%;">
                                        <li><a href="/Extruder/ExtruderNet/formMojosariD_KonversiMohon">Permohonan
                                                Konversi
                                                Barang</a></li>
                                        <li><a href="/Extruder/ExtruderNet/formMojosariD_KonversiACC">ACC Permohonan
                                                Konversi</a></li>
                                    </ul>
                                </li>
                                <li class="dropdown">
                                    <a href="#"><span>Sortir Benang NG</span>
                                        <i class="bi bi-chevron-right"></i></a>
                                    <ul style="transition: 0.3s; left: -75%;">
                                        <li><a href="/Extruder/ExtruderNet/formMojosariD_BenangMohon">Permohonan Sortir
                                                Benang NG</a></li>
                                        <li><a href="/Extruder/ExtruderNet/formMojosariD_BenangACC">ACC Sortir Benang
                                                NG</a></li>
                                    </ul>
                                </li>
                                <li><a href="/Extruder/ExtruderNet/formMojosariD_GangguanProduksi">Pencatatan Gangguan
                                        Produksi</a>
                                <li><a href="/Extruder/ExtruderNet/formMojosariD_Daya">Pencatatan KwaH Produksi</a>
                                <li><a href="/Extruder/ExtruderNet/formMojosariD_Efisiensi">Pencatatan Efisiensi</a>
